...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-shrutikalyankar.git;protocol=ssh;branch=main \
           file://aesdsocket-start-stop.sh \
           file://aesdsocket.init \
          "

# Pin to a specific commit in your assignments repo
SRCREV = "ed31d59cd15844ddb0c3504f89b78a673e90daf5"
